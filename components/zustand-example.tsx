      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div>
            ...
            {languageError && (
              <p className="text-red-500">Error: {languageError}</p>
            )}
          ...
          <div>
            ...
            <div className="flex gap-2 mb-4">
              ...
              <Button
                ...
                disabled={
                  lexemeLoading || !selectedSourceLanguage || !query.trim()
                }
              >
            ...
            {lexemeError && (
              <p className="text-red-500">Error: {lexemeError}</p>
            )}
            {lexemes.length > 0 && (
              <div className="space-y-2">
                <p className="text-sm text-gray-600">
                  Found {lexemes.length} results:
                </p>
                {lexemes.map((lexeme) => (
              ...
              <Card className="p-4">
                <div className="mb-4">
                  <h4 className="font-medium">
                    Lexeme: {selectedLexeme.lexeme.id}
                  </h4>
                  <p className="text-sm text-gray-600">
                  ...
                  {JSON.stringify(
                    {
                      ...
                      selectedSourceLanguage:
                        selectedSourceLanguage?.lang_label,
                      selectedTargetLanguage1:
                        selectedTargetLanguage1?.lang_label,
                      selectedTargetLanguage2:
